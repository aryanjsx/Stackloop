...
import { CollectionRepository } from '../interfaces.js';

export class PrismaCollectionRepository extends BaseRepository<any, any, any> implements CollectionRepository {
  protected modelName = 'collection' as keyof PrismaClient;
