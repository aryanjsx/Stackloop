...
import { ContributionRepository } from '../interfaces.js';

export class PrismaContributionRepository extends BaseRepository<any, any, any> implements ContributionRepository {
  protected modelName = 'contribution' as keyof PrismaClient;
