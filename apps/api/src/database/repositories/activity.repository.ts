...
import { ActivityRepository } from '../interfaces.js';

export class PrismaActivityRepository extends BaseRepository<any, any, any> implements ActivityRepository {
  protected modelName = 'activity' as keyof PrismaClient;
